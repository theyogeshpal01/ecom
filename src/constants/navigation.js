export const HEADER_LINKS = [
  ...
  { 
    ...
    dropdownItems: [
      ...
      { label: 'Handcrafted Metal categories', href: '/categories/metal', hasArrow: true },
      { label: 'Handcrafted Stone categories', href: '/categories/stone', hasArrow: true },
      { label: 'Handcrafted Wooden categories', href: '/categories/wooden', hasArrow: true },
