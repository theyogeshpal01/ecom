...
const features = [
  ...
  { icon: <Medal size={32} strokeWidth={1.5} />, title: 'Premium Quality', desc: 'Handpicked products with 7+ years of expertise' },
      ...
      <div className={styles.topSection}>
        <div className={styles.topContainer}>
          <div className={styles.leftCol} ref={leftRef} style={{opacity:0,transform:'translateX(-40px)',transition:'opacity 0.7s ease,transform 0.7s ease'}}>
            ...
            <h2 className={styles.title}>Handcrafted Products,<br />Inspired By India</h2>
