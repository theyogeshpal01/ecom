      ...
      <section className="cs-offer-section">
        <div className="container">
          <div className="section-header" data-aos="fade-up">
            <h2>What We Offer</h2>
            <p>Comprehensive Custom Development Solutions</p>
          </div>
          <div className="offer-grid">
            <div className="offer-card" data-aos="fade-up" data-aos-delay="100">
              <div className="offer-icon"><Palette size={40} /></div>
            ...
            <div className="offer-card" data-aos="fade-up" data-aos-delay="200">
              <div className="offer-icon"><Users size={40} /></div>
        ...
        <div className="container">
          ...
          <div className="process-steps-container">
            {processSteps.map((step, index) => (
              <div className="cs-process-step" key={index} data-aos="fade-left" data-aos-delay={index * 100}>
