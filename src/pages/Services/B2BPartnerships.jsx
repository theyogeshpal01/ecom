...
const B2BPartnerships = () => {
  ...
  const networks = [
    ...
    { title: 'Hotel Chains', icon: <Hotel size={40} />, desc: 'Long-term contracts with hotel chains for consistent supply of premium quality products and custom solutions.' },
  ...
  return (
    <div className="b2b-page">
      ...
      <section className="b2b-hero">
        <div className="b2b-hero-content" data-aos="fade-up">
          <span className="b2b-tag">B2B Partnerships</span>
          <h1 className="b2b-title">More Than Just Shipping — We Build Relationships</h1>
          <p className="b2b-subtitle">
            We don't just ship products — we build long-term business relationships. Our partnership approach focuses on understanding your unique business needs and providing flexible solutions that support your growth strategy. With dedicated support and reliable service, we become your trusted export partner invested in your long-term success.
          </p>
        </div>
      </section>
      ...
      <section className="b2b-networks-section">
        <div className="container">
          <div className="section-header" data-aos="fade-up">
            <h2>Our Partnership Network</h2>
            <p>Diverse Business Relationships Across Industries</p>
          </div>
        ...
        <div className="container">
          ...
          <div className="models-grid">
            {partnershipModels.map((model, index) => (
              <div className="model-card" key={index} data-aos="fade-up" data-aos-delay={index * 100}>
      ...
      <section className="b2b-advantage-section">
        <div className="container">
          ...
          <div className="advantage-boxes-grid">
            {advantages.map((item, index) => (
              <div className="adv-box" key={index} data-aos="fade-up" data-aos-delay={index * 100}>
                <div className="adv-box-icon">{item.icon}</div>
                <div className="adv-box-content">
                  <h4>{item.title}</h4>
                  <p>{item.desc}</p>
                </div>
              </div>
        ...
        <div className="container">
          ...
          <div className="terms-grid">
            {flexibleTerms.map((item, index) => (
              <div className="term-card" key={index} data-aos="fade-up" data-aos-delay={index * 100}>
        ...
        <div className="container">
          ...
          <div className="reasons-grid">
            {reasons.map((adv, index) => (
              <div className="reason-item" key={index} data-aos="fade-up" data-aos-delay={index * 50}>
                <div className="reason-icon">{adv.icon}</div>
        ...
        <div className="container">
          ...
          <div className="process-steps-container">
            {processSteps.map((step, index) => (
              <div className="b2b-process-step" key={index} data-aos="fade-left" data-aos-delay={index * 100}>
