      ...
      <section className="aff-hero">
        <div className="aff-hero-content" data-aos="fade-up">
          ...
          <p className="aff-subtitle">
            Join our community and earn as you share the excellence of HIEIL. Become a part of the HIEIL success story. Our affiliate program is designed for creators, curators, and connectors who want to share premium, trend-setting categories with their audience while earning competitive commissions.
          </p>
        </div>
      </section>
