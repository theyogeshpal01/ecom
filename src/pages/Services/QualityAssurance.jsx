  ...
  return (
    <div className="qa-page">
      ...
      <section className="qa-hero">
        <div className="qa-hero-content" data-aos="fade-up">
          <span className="qa-tag">Quality Assurance</span>
          <h1 className="qa-title">Uncompromising Quality Standards</h1>
          <p className="qa-subtitle">
            We believe that quality is not an act, but a habit. Our rigorous quality assurance protocols ensure that every handcrafted piece meets international standards and exceeds your expectations. From raw material sourcing to final packaging, excellence is built into every step.
          </p>
        </div>
      </section>
      ...
      {/* Quality Standards */}
      <section className="qa-standards-section">
        <div className="container">
          ...
          <div className="standards-grid">
            {standards.map((standard, index) => (
              <div className="standard-card" key={index} data-aos="fade-up" data-aos-delay={index * 100}>
      ...
      {/* Detailed Checks */}
      <section className="qa-checks-section">
        <div className="container">
          <div className="section-header" data-aos="fade-up">
          ...
          <div className="checks-grid">
            {qualityChecks.map((check, index) => (
              <div className="check-card" key={index} data-aos="fade-up" data-aos-delay={index * 100}>
        ...
        <div className="container">
          ...
          <div className="process-steps-container">
            {processSteps.map((step, index) => (
              <div className="qa-process-step" key={index} data-aos="fade-left" data-aos-delay={index * 100}>
