  ...
  return (
    <div className="wholesale-page">
      ...
      <section className="ws-hero">
        <div className="ws-hero-content" data-aos="fade-up">
          <span className="ws-tag">Bulk Wholesale Supply</span>
          <h1 className="ws-title">Scaling Your Business with Consistent Quality</h1>
      ...
      <section className="ws-offer-section">
        <div className="container">
          <div className="section-header" data-aos="fade-up">
            <h2>Why Choose Our Wholesale Services</h2>
            <p>Comprehensive Solutions for Volume Business</p>
          </div>
        ...
        <div className="container">
          ...
          <div className="process-steps-container">
            {processSteps.map((step, index) => (
              <div className="ws-process-step" key={index} data-aos="fade-left" data-aos-delay={index * 100}>
